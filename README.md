...
события кадр со счётчиками не получает ACK, и архив может застрять до устранения
проблемы часов или решения о его ручной обработке. Время последней фиксации
координат не подменяет время события.
